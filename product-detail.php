                ...
                if (isset($_GET['id']) ) {
                    ...
                    if ($result->num_rows > 0) {
                        while ($row= $result->fetch_assoc()) {
                            if (gettype(unserialize($row['tags']))=='array' ) {
                                $test=unserialize($row['tags']);
                                foreach ($test as $key=>$value) {
                            
                                    if ($random>0) {
                                        $page='<div class="col-md-5 col-sm-5 col-xs-12">                              
                                        <div class="aa-product-view-slider">                                
                                          <div id="demo-1" class="simpleLens-gallery-container">
                                            <div class="simpleLens-container">
                                              <div class="simpleLens-big-image-container"><a data-lens-image="' . $row['image'] . '" class="simpleLens-lens-image"><img src="img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                                            </div>
                                        ...
                                        $page=' <div class="col-md-7 col-sm-7 col-xs-12">
                                        <div class="aa-product-view-content">
                                          ...
                                          <p>' . $row['discription'] . '</p><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis animi, veritatis quae repudiandae quod nulla porro quidem, itaque quis quaerat!</p>
                                          <h4>Size</h4>
